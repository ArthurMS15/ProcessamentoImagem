...
# Carregar as imagens
img1 = cv2.imread('pcbCropped.png', 0) # 0 para carregar em escala de cinza
img2 = cv2.imread('pcbCroppedTranslateDefected.png', 0) # 0 para carregar em escala de cinza
